...
public interface TacticalConfigOptions {
    ...
    boolean prettyPrint();
    /**
     * Determines weather the current {@link TacticalFileConfig} should use pretty print when saving the file
    ...
    /**
     * Returns the tab size used when saving the current {@link TacticalFileConfig}
     * @return the current tab size used
     * @see TacticalConfigOptions#tabSize(int)
     */
    int tabSize();
    /**
     * Sets the tab size used when saving the current {@link TacticalFileConfig}
