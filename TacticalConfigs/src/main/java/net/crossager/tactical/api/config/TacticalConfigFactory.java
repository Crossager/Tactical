...
public interface TacticalConfigFactory {
    /**
     * Creates a new {@link TacticalFileConfig}
     ...
     */
    @NotNull
    TacticalFileConfig create(@NotNull TacticalConfigSerializer type, @NotNull File file) throws IOException;
    /**
     * Creates a new {@link TacticalFileConfig}
     * @param type the way you want data to be stored
     ...
     */
    @NotNull
    TacticalFileConfig create(@NotNull TacticalConfigSerializer type, @NotNull String path) throws IOException;
    /**
     * Creates a new {@link TacticalFileConfig}
     * @param type the way you want data to be stored
     ...
     */
    @NotNull
    TacticalFileConfig create(@NotNull TacticalConfigSerializer type, @NotNull File parent, @NotNull String path) throws IOException;
}
