...
public interface TacticalConfigSection extends Cloneable {
     ...
     * @see TacticalConfigSection#createSection(String)
     * @see TacticalConfigSection#createList(String)
     */
    @NotNull
     ...
     * @see TacticalConfigValue#createSection()
     */
    @NotNull
    TacticalConfigSection createSection(@NotNull String path);
     ...
     * @see TacticalConfigValue#createList()
     */
    @NotNull
    TacticalConfigList createList(@NotNull String path);
